...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "foqBlock".
 */
export interface FoqBlock {
  title: string;
  question: {
    Question: string;
    answer?: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "foqBlock_select".
 */
export interface FoqBlockSelect<T extends boolean = true> {
  title?: T;
  question?:
    | T
    | {
